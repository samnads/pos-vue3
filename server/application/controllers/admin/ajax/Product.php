        ...
        switch ($_SERVER['REQUEST_METHOD']) {
            ...
            case 'POST': // add new product
                ...
                $data = array(
                    ...
                    'cost' => $this->input->post('cost_bef_tax') ?: NULL,
                    ...
                    'pos_sale_custom_discount' => $this->input->post('pos_sale_custom_discount') ? '1' : '0',
                    'pos_sale_custom_tax' => $this->input->post('pos_sale_custom_tax') ? '1' : '0',
