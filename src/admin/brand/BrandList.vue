  ...
  <div class="form-inline menubar" id="menubar">
    <div class="d-flex bd-highlight align-items-baseline">
      <div class="p-2 flex-grow-1 bd-highlight">
        <h5 class="title">
          <i class="fa-solid fa-copyright"></i><span>Brands</span>
        </h5>
      </div>
  ...
  mounted() {
    ...
    $(function () {
      ...
      self.table = $("#datatable").DataTable({
        ...
        ajax: {
          method: "GET",
          url: config.VUE_APP_API_ROOT + "admin/ajax/brand",
        ...
        language: {
          ...
          infoEmpty: "No brand info found",
          emptyTable: "No brad found",
          infoFiltered: "(filtered from _MAX_ brands)",
          paginate: {
            first: "First",
            last: "Last",
        ...
        buttons: [
          ...
          },
          {
            ...
            className: "btn-light",
            action: function () {
              self.emitter.emit("newBrandModal", {
                title: "New Brand",
                type: "success",
                emit: "refreshBrandDataTable",
              });
            },
            attr: {
              "data-bs-toggle": "tooltip",
      ...
      $("#datatable tbody").on("click", "#delete", function () {
        ...
        self.emitter.emit("deleteConfirmModal", {
          title: null,
          body: "Delete brand with name <b>" + row.name + "</b> ?",
          data: row,
          emit: "confirmDeleteBrand",
          hide: true,
          type: "danger",
        });
      });
    ...
    self.emitter.on("confirmDeleteBrand", (data) => {
    ...
    self.emitter.on("refreshBrandDataTable", (data) => {
      self.table.ajax.reload();
    });
  },
  beforeUnmount() {
    var self = this;
    self.emitter.off("confirmDeleteBrand");
    self.emitter.off("refreshBrandDataTable");
