  ...
  <div class="form-inline menubar" id="menubar">
    <div class="d-flex bd-highlight align-items-baseline">
      <div class="p-2 flex-grow-1 bd-highlight">
        <h5 class="title">
          <i class="fa-solid fa-percent"></i><span>Tax Rates</span>
        </h5>
      </div>
  ...
  mounted() {
    ...
    $(function () {
      ...
      self.table = $("#datatable").DataTable({
        ...
        ajax: {
          method: "GET",
          url: config.VUE_APP_API_ROOT + "admin/ajax/tax",
        ...
        language: {
          ...
          zeroRecords: "No matching tax rate found",
          info: "Showing _START_ to _END_ of _TOTAL_ tax rates",
          infoEmpty: "No tax rate info found",
          emptyTable: "No tax rate found",
        ...
        buttons: [
          ...
          },
          {
            ...
            className: "btn-light",
            action: function () {
              self.emitter.emit("newTaxModal", {
                title: "New Tax Rate",
                type: "success",
                emit: "refreshTaxDataTable",
              });
            },
            attr: {
              "data-bs-toggle": "tooltip",
      ...
      $("#datatable tbody").on("click", "#delete", function () {
        ...
        self.emitter.emit("deleteConfirmModal", {
          title: null,
          body: "Delete tax rate <b>" + row.name + "</b> ?",
          data: row,
          emit: "confirmDeleteTax",
          hide: true,
          type: "danger",
        });
      });
    ...
    self.emitter.on("confirmDeleteTax", (data) => {
    ...
    self.emitter.on("refreshTaxDataTable", (data) => {
      self.table.ajax.reload();
    });
  },
  beforeUnmount() {
    var self = this;
    self.emitter.off("confirmDeleteTax");
    self.emitter.off("refreshTaxDataTable");
