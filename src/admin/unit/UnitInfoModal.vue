<template>
  <div class="modal" id="unitInfoModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        <form @submit="onSubmit" class="needs-validation">
          <div class="modal-header">
            <h5 class="modal-title"><span><i class="fa-solid fa-circle-info"></i></span>Unit Information</h5>
            <button
              type="button"
              class="btn-close"
...
export default {
  ...
  created() {},
  mounted() {
    window.UNIT_INFO_MODAL = new Modal($("#unitInfoModal"), {
      backdrop: true,
      show: true,
    });
  },
