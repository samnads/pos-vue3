...
(1,	'CUST0041',	1,	'Walk-In Customer',	'yuytuyuyt',	NULL,	NULL,	NULL,	NULL,	NULL,	'oipi',	NULL,	NULL,	'ACTIVE',	'2022-06-30 16:11:34',	'2022-08-05 15:18:41',	'2022-07-09 13:54:01'),
...
CREATE TABLE `pos_sale` (
  ...
  `return_amount` decimal(15,4) DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `pos_sale_ibfk_5` FOREIGN KEY (`return`) REFERENCES `pos_sale` (`id`),
...
CREATE TABLE `pos_sale_product` (
  ...
  CONSTRAINT `pos_sale_product_ibfk_3` FOREIGN KEY (`tax_rate`) REFERENCES `tax_rate` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1,	'C1',	1,	'admin',	'$2y$10$6XeS4Sx0lGQzUWsqoSqaDOsaoM2wSVQAmDQg4viwBD4b5WAFw4SBu',	'Samnad',	'S',	'Cna',	'1992-10-30',	'admin@example.com',	'+91-0000000012',	NULL,	1,	'India',	'TVM',	'Trivandrum',	'695505',	'CyberLikes Pvt. Ltd.',	'something',	3,	0,	0,	'::1',	'2022-08-05 18:15:18',	'2022-08-05 18:15:17',	'2021-04-20 19:22:52',	'2022-08-05 18:15:18',	NULL),
